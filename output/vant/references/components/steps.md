...
| active-icon | 当前步骤对应的底部图标，可选值见Icon 组件 | string | `checked` |
| inactive-icon | 非当前步骤对应的底部图标，可选值见Icon 组件 | string | - |
| finish-icon | 已完成步骤对应的底部图标，优先级高于`inactive-icon`，可选值见Icon 组件 | string | - |
