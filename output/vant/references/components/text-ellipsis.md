...
| dots`v4.2.0` | 省略号的文本内容 | string | `'...'` |
| position`v4.6.2` | 省略位置，可选值为`start``middle` | string | `'end'` |
...
| 名称 | 说明 | 参数 |
| --- | --- | --- |
| action`v4.8.3` | 自定义操作 | { expanded: boolean } |
...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --van-text-ellipsis-action-color | var(--van-blue) | 操作按钮的颜色 |
| --van-text-ellipsis-line-height | 1.6 | 文本的行高 |
