...
| 参数 | 说明 | 类型 | 默认值 |
| --- | --- | --- | --- |
| v-model:main-active-index | 左侧选中项的索引 | number \| string | `0` |
| v-model:active-id | 右侧选中项的 id，支持传入数组 | number \| string \|(number \| string)[] | `0` |
...
| 名称 | 说明 | 参数 |
| --- | --- | --- |
| nav-text`v4.1.0` | 自定义导航名称 | item: TreeSelectChild |
| content | 自定义右侧区域内容 | - |
